	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.authorizeRequests()
				...
				.antMatchers("/css/**", "/js/**", "/h2/**"/*not suitable for production level app*/, "WEB-INF/jsps/**", "/", "/**/*.png", "/register", "/editUserDetails", "/filtered", "/dropDownFilters", "/forgottenPassword", "/terms", "/*.png", "/*.jpg").permitAll()
